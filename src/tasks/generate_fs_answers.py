...
def generate_full_sentences(fs_fir=FULL_SENTENCE_DATA_DIR):
    ...
    with open(fs_fir+'/train_full_sentence.json', 'a') as fp:
        fp.write(j)
    train_data =[]  
    ...
    with open(fs_fir+'/val_full_sentence.json', 'a') as fp:
        fp.write(j)
    val_data =[] 
    ...
    with open(fs_fir+'/test_full_sentence.json', 'a') as fp:
        fp.write(j)
    test_data =[]  
